  ...
  return (
    ...
    >
      <Stack
        ...
        spacing={{md:"250px",xs:"50px"}}
        marginLeft={{md:"0px",xs:"20px"}}
      >
        <Box>
          <Box component="img" src={Img1} mt={{ md: "40px", xs: "20px" }} />
        ...
        >
          ...
          >
            <Box
              component="img"
              src={acc1}
              sx={{ width: { md: "40px", xs: "40px" }, height: { md: "40px" } }}
            />
      ...
      <Stack sx={{color:{md:"#fff"}}} direction={{md:"row",xs:'column'}} spacing={30}  margin={{md:"auto"}}         width={{ md: "75%", xs: "100%" }}
 border={{md:"1px solid white"}}  >
      <Stack direction={{md:"row",xs:'column'}} spacing={3}> 
      <Typography>@2022 kelly + Partners Chartered Accountants</Typography>
      <Typography>Terms of Business</Typography>
      <Typography>Location <KeyboardArrowDownIcon sx={{color:"#fff"}}/></Typography>
</Stack>
